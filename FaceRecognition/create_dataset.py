...
def start_capture(name):
        path = "C:\\Users\\riyam\\PycharmProjects\\MajorProject\\FaceRecognition\\data\\" + name
        num_of_images = 0
        detector = cv2.CascadeClassifier("C:\\Users\\riyam\\PycharmProjects\\MajorProject\\FaceRecognition\\data\\haarcascade_frontalface_default.xml")
        try:
            os.makedirs(path)
        except:
